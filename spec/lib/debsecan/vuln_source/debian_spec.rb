...
RSpec.describe Debsecan::VulnSource::Debian do
  ...
  describe '#update' do
    ...
    it 'returns an UpdateResponse' do
      expect(subject.update).to be_a(Debsecan::UpdateResponse)
    end
    ...
    context '.content' do
      ...
      context 'aptdaemon' do
        ...
        context 'CVE-2015-1323' do
          ...
          let(:severity) { Debsecan::Severity::Low }
        ...
        context 'CVE-2003-0779' do
          ...
          let(:severity) { Debsecan::Severity::Critical }
      ...
      context 'asterisk' do
        ...
        context 'CVE-2013-2685' do
          ...
          let(:severity) { Debsecan::Severity::Negligible }
        ...
        context 'CVE-2003-0779' do
          let(:identifier) { 'CVE-2003-0779' }
          let(:severity) { Debsecan::Severity::High }
          let(:description) { 'But this one is very dangerous.' }
          let(:versions) { ['0.5.56'] }
